...
const books = [
  {
    ...
    title: 'Learn',
    author: 'Auteur 1',
    image: '/Civilisation Française.jpg',
    slug: 'livre-1'
  },
  {
    id: 2,
    title: 'Learn',
    author: 'Auteur 2',
    image: '/Littérature jeunesse.jpg',
    slug: 'livre-2'
  },
  {
    id: 3,
    title: 'Learn',
    author: 'Auteur 2',
    image: '/Littérature française.jpg',
    slug: 'livre-3'
  },
  {
    id: 4,
    title: 'Learn',
    author: 'Auteur 4',
    image: '/comprendre la littérature française.jpg',
    slug: 'livre-4'
  },
...
const BookPage = () => {
  ...
  const fetchBooks = async (keywords:string='') => {
    ...
    headers.append('genre', 'litterature');
