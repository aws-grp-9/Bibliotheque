...
import { FaBook, FaUserFriends, FaFileAlt, FaDatabase } from 'react-icons/fa';
...
const newsData = [
    {
        ...
        date: '2024-04-10',
        link: '/exposition',
        image: '/conf.png' // Chemin vers l'image de l'exposition
    },
    {
        id: 2,
...
const NewsSection = () => {
    return (
        <section className="max-w-7xl mx-auto my-5 px-2">
            <h2 className="text-4xl font-bold mb-9 text-left">Évènements à venir</h2>
